...
export function ScrollArea({ children }: ScrollAreaProps) {
  return (
    <Scroll.Root className="overflow-hidden h-full">
      ...
      <Scroll.Scrollbar
        className="flex select-none touch-none bg-gray800 hover:bg-gray800 data-[orientation=vertical]:w-[4px] data-[orientation=horizontal]:flex-col data-[orientation=horizontal]:h-2.5"
