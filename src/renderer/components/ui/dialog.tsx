...
const dialogContentStyles = tv({
  ...
  variants: {
    theme: {
      ...
      [Theme.DARK]: 'bg-gray100 border-purple700 text-text100',
      [Theme.SYSTEM]: '',
    },
  },
});
...
const DialogContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & {
    isToShowClose?: boolean;
  }
>(({ className, children, isToShowClose = true, ...props }, ref) => {
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ref={ref}
        className={dialogContentStyles({ className, theme })}
        {...props}
      >
        {children}
        {isToShowClose && (
